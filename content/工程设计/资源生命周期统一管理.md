...
`YooAssetManager.ResourceAccess.cs`

## 核心知识点

资源管理里最重要的不是“引用计数这个数字本身”，而是资源的获取和释放必须有统一入口、统一规则、统一生命周期归属。
...
```text
所有业务都通过 ResourceManager / YooAssetManager 加载资源。
```
